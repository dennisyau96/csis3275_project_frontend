...
function SystemAdmin() {
  return (
    <>
      <div id="adminPage" className="flex flex-col-6 m-3 rounded-sm">
        <div
          id="adminSideBarDiv"
          className="m-0 bg-orange-100 inline-block w-40 col-span-1  "
        >
          <nav id="sidebar" className="m-0 rounded-s-md">
            <ul className="list-unstyled rounded-sm">
        ...
        <div
          id="pageContent"
          className="cursor-pointer col col-span-5 bg-white p-5 rounded-md "
        >
          <div className="">
