...
function DogCard() {
  return (
    <>
      <div className="border-2 m-4 w-60 hover:w-80 hover:transition-all rounded-md shadow-md bg-white border-black">
        ...
        <div className="p-2">
          ...
          <div className=" grid grid-cols-2 space-x-3 justify-items-center">
            <button className=" inline bg-orange-400 p-1 w-20 text-center border-black border-2 shadow-sm hover:bg-blue-300">
              Details
            </button>
